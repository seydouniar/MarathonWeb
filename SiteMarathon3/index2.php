...
<div class="container text-center">    
  ...
  <div class="row">       
    <div class="col-sm-6">
      <p class="upperBlue">Opportunite<br>d'achat / vente</p>
      <div class="weller">
        <!-- Table of bourse title result -->
        <div>
        <form action="127.0.0.1:8080/api" method="get" >
    ...
    <div class="col-sm-6" MarathonWeb-master/CAC40/temp-plot.html>
      <p class="upperBlue">Cours actuel<br>de l'action</p>
      <?php
