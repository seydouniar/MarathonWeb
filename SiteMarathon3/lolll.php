...
<nav class="navbar">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <div style="white-space: nowrap; /* interdiction de passer à la ligne */">
...
<div class="container text-center">    
  ...
  <div class="row">       
    <div class="col-sm-12">
      <p>Opportunite d'achat / vente</p>
      <div class="weller">
        
       <a href="index2.php"><img id="tablePic" src="images/tableBourse.jpg"></a>
      </div>
    </div  w3-include-html="MarathonWeb-master/CAC40/temp-plot.html">
    <!--<div class="col-sm-6" >
